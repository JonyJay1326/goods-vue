 ...
 * 
 */
class BatchPoBwModel extends ExcelOperationModel
{
    ...
    public function main()
    {
        ...
        if ($ord_ids) {
            ...
            if($model->data($data)->where('ORD_ID in ('.$ids.')')->save() === count($this->can_po)){
                ...
                $log = A('Log');
                $rs = $log->IndexExtend($ord_ids, static::IN_CONFIRMATION, 'PO确认失败');
            }
